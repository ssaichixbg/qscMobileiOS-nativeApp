...
- (void)show:(UIView *)sender{
    ...
    [self startAnimationCycleFromFrame:CGRectMake(max_width/2-[self getDefaultSizeInScale:0.7].width/2,-10,[self getDefaultSizeInScale:0.7].width, [self getDefaultSizeInScale:0.7].height) throughKeyFrame:CGRectMake((max_width-[self getDefaultSizeInScale:1.0].width)/2, max_height/2-60, [self getDefaultSizeInScale:1.0].width, [self getDefaultSizeInScale:1.0].height) toDestinationFrame:CGRectMake((max_width-[self getDefaultSizeInScale:0.2].width)/2, max_height-20,[self getDefaultSizeInScale:0.2].width, [self getDefaultSizeInScale:0.2].height)];
}
